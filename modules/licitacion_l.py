    ...
    try:
        ...
        for fila_idx in range(total_filas):
            ...
            try:
                ...
                # =========================================
                # SOLO PROVEEDOR DEL RUT BUSCADO
                # =========================================

                rut_limpio = rut.replace(".", "").replace("-", "").strip()
                rut_proveedor_limpio = (
                    rut_proveedor
                    .replace(".", "")
                    .replace("-", "")
                    .strip()
                ...
                if rut_limpio not in rut_proveedor_limpio:
                    continue

                print("\nRUT CORRECTO ENCONTRADO")
                print(rut_proveedor)
                print(proveedor)
                ...
                if not emails_acumulados and not telefonos_acumulados:
                    print("\nNO SE ENCONTRO CONTACTOS")

                    datos_proveedor["email_1"] = "NO SE ENCONTRO CONTACTOS"
                    datos_proveedor["telefono_1"] = "NO SE ENCONTRO CONTACTOS"
                    ...
                    try:
                        ...
                        for año in años:
                            ...
                            try:
                                ...
                                if monto_actual > 0 or orden_actual > 0:
                            ...
                            if not ventas_encontradas:
                                ...
                                datos_proveedor["ventas"] = "NO SE ENCONTRO VENTAS"
                        ...
                        try:
                            ...
                            try:
                                ...
                                if (
                                        not datos_proveedor.get("socios")
                                        and not datos_proveedor.get("beneficiario_final")
                                        and not datos_proveedor.get("estado_habilidad")
                                ):
                                    print("\nNO REGISTRA DATOS EN SU FICHA DE PROVEEDOR")

                                    datos_proveedor["socios"] = (
                                        "NO REGISTRA DATOS EN SU FICHA DE PROVEEDOR"
                                    )

                                    datos_proveedor["beneficiario_final"] = (
                                        "NO REGISTRA DATOS EN SU FICHA DE PROVEEDOR"
                                    )

                                    datos_proveedor["estado_habilidad"] = (
                                        "NO REGISTRA DATOS EN SU FICHA DE PROVEEDOR"
                                    )
